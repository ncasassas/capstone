...
'''
Modelo de Markowitz en S&P - Capstone Investigación Operativa
'''
...
'''
path_covs = f'matriz_cov_S&P/S&P_cov.csv'
path_json = f'rendimientos_S&P/rendimientos_promedio_S&P.json'
...
z = {}
for j in range(N):
    w[j] = model.addVar(lb=0, ub=upper_bound, name=f'{numbers_to_names[j]}')
